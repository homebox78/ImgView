...
contextBridge.exposeInMainWorld('imgview', {
  ...
  pasteFiles:    (payload) => ipcRenderer.invoke('paste-files', payload),
  newFolder:     (payload) => ipcRenderer.invoke('new-folder', payload),
  copyImageClipboard:(payload)=>ipcRenderer.invoke('copy-image-clipboard', payload),
  saveAs:        (payload) => ipcRenderer.invoke('save-as', payload),
